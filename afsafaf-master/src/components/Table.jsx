  ...
  function deleteUser(id) {
    if (window.confirm("Delete the item?")) {
      fetch(`https://northwind.vercel.app/api/suppliers/${id}`, {
        ...
        .then((data) => {
          fetchUsers(Users.filter(x => x.id !== id))
        })
    }
  }
  const handleView=(id)=>{
            ...
            <TableBody>
              {Users.map((item, i) => (
                <StyledTableRow >
                  ...
                  <StyledTableCell align="center"><button id="viewbtn" onClick={() => handleView(item.id)}>View</button></StyledTableCell>
                  <StyledTableCell align="center"><button id="editbtn" onClick={() => handleEdit(item.id)}>Edit</button></StyledTableCell>
